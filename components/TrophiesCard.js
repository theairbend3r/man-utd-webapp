...
const TrophiesCard = props => {
  ...
  return (
    <div tw="flex flex-shrink-0 m-4 p-2 flex-row items-center justify-around rounded shadow-lg h-40 w-full sm:flex-col sm:w-56 sm:h-32 md:m-6 md:w-64 md:h-48 lg:w-72 lg:h-56">
      <div>
        <img
